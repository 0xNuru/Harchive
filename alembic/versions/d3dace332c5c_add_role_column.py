...
Revision ID: d3dace332c5c
Revises: 8685908de4e9
Create Date: 2023-02-24 04:14:34.850174
...
revision = 'd3dace332c5c'
down_revision = '8685908de4e9'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['id'], ['user.id'], name='patient_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='patient_pkey'),
    sa.UniqueConstraint('insuranceID', name='patient_insuranceID_key')
    )
    op.create_table('transactions',
    sa.Column('id', sa.VARCHAR(length=200), autoincrement=False, nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('hospital_record_id', sa.VARCHAR(), autoincrement=False, nullable=True),
    ...
    sa.ForeignKeyConstraint(['doctor_id'], ['doctors.id'], name='transactions_doctor_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['hospital_record_id'], ['record.id'], name='transactions_hospital_record_id_fkey', ondelete='CASCADE'),
    ...
    sa.Column('hospital_record_id', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['hospital_record_id'], ['record.id'], name='immunization_hospital_record_id_fkey', ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['hospitalID'], ['hospital.id'], name='hospitalWorkers_hospitalID_fkey', ondelete='CASCADE'),
    ...
    sa.Column('doctor_id', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('hospital_record_id', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['doctor_id'], ['doctors.id'], name='test_doctor_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['hospital_record_id'], ['record.id'], name='test_hospital_record_id_fkey', ondelete='CASCADE'),
    ...
    sa.Column('hospital_record_id', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('doctor_id', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['doctor_id'], ['doctors.id'], name='medications_doctor_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['hospital_record_id'], ['record.id'], name='medications_hospital_record_id_fkey', ondelete='CASCADE'),
    ...
    sa.Column('id', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('hospitalID', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['hospitalID'], ['hospitalWorkers.id'], name='admin_hospitalID_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['id'], ['user.id'], name='admin_id_fkey', ondelete='CASCADE'),
    ...
    sa.Column('hospital_record_id', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['hospital_record_id'], ['record.id'], name='allergy_hospital_record_id_fkey', ondelete='CASCADE'),
    ...
    sa.Column('hospitalID', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['hospitalID'], ['hospitalWorkers.id'], name='doctors_hospitalID_fkey'),
    sa.ForeignKeyConstraint(['id'], ['user.id'], name='doctors_id_fkey', ondelete='CASCADE'),
